...
internal class AccountContext : EntityContext<Account>, IAccountContext
{
        ...
        string eabKeyId = null, string eabKey = null, string eabKeyAlg = null)
    {
        ...
        if (eabKeyId != null && eabKey != null)
        {
            ...
            var headerJson = JsonSerializer.Serialize(header,JsonUtil.CreateJsonSettings());
            ...
            var accountKeyBase64 = JwsConvert.ToBase64String(
                System.Text.Encoding.UTF8.GetBytes(
                    JsonSerializer.Serialize(context.AccountKey.JsonWebKey)
                )
            );
        ...
        return await context.HttpClient.Post<Account, Account>(jws, endpoint, body, ensureSuccessStatusCode);
    }
}
