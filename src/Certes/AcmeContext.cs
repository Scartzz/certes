...
public class AcmeContext : IAcmeContext
{
    ...
    public async Task<Account> ChangeKey(IKey key)
    {
        ...
        var resp = await HttpClient.Post<JwsPayload, Account>(this, endpoint, body, true);
    ...
    public async Task RevokeCertificate(byte[] certificate, RevocationReason reason, IKey certificatePrivateKey)
    {
        ...
        if (certificatePrivateKey != null)
        {
            ...
            await HttpClient.Post<CertificateRevocation, string>(jws, endpoint, body, true);
        }
        else
        {
            await HttpClient.Post<CertificateRevocation, string>(this, endpoint, body, true);
