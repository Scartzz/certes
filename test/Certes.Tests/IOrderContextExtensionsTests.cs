...
public class IOrderContextExtensionsTests
{
    ...
    public async Task CanGenerateWithAlternateLink()
    {
        ...
        httpClientMock.Setup(m => m.Post<object, string>(certDefaultLoc, It.IsAny<object>()))
        ...
        httpClientMock.Setup(m => m.Post<object, string>(certAlternateLoc, It.IsAny<object>()))
            .ReturnsAsync(new AcmeHttpResponse<string>(
                accountLoc, 
                alternatepem,
                alternates, 
        ...
        httpClientMock.Setup(m => m.Post<object, Order>(finalizeLoc, It.IsAny<object>()))
