...
public class AcmeHttpClientTests
{
    private class MockHttpMessageHandler : HttpMessageHandler
    {
        ...
        private readonly JsonSerializerOptions jsonSettings = JsonUtil.CreateJsonSettings();
        ...
        protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
        {
            ...
            if (request.RequestUri.AbsoluteUri.EndsWith("directory"))
            {
                ...
                {
                    Content = new StringContent(JsonSerializer.Serialize(Helper.MockDirectoryV2, jsonSettings), Encoding.UTF8, "application/json"),
                };
            }
    ...
    public async Task RetryOnBadNonce()
    {
        ...
        httpMock.SetupSequence(
                m => m.Post<object, Account>(MockDirectoryV2.NewAccount, It.IsAny<object>()))
        ...
        httpMock.Verify(m => m.Post<object, Account>(MockDirectoryV2.NewAccount, It.IsAny<object>()), Times.Exactly(2));
    ...
    public async Task ThrowOnMultipleBadNonce()
    {
        ...
        httpMock.Verify(m => m.Post<object, Account>(MockDirectoryV2.NewAccount, It.IsAny<object>()), Times.AtMost(2));
    }
}
