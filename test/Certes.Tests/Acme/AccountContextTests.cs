...
public class AccountContextTests
{
    ...
    public async Task CanDeactivateAccount()
    {
        ...
        contextMock
            ...
            {
                Assert.Equal(
                    JsonSerializer.Serialize(new Account { Status = AccountStatus.Deactivated }),
        ...
        httpClientMock
            .Setup(c => c.Post<JwsPayload, Account>(location, expectedPayload))
        ...
        httpClientMock.Verify(c => c.Post<JwsPayload, Account>(location, expectedPayload), Times.Once);
    ...
    public async Task CanLoadResource()
    {
        ...
        httpClientMock
            ...
            .ReturnsAsync("nonce");
        httpClientMock
            .Setup(c => c.Post<JwsPayload, Account>(location, It.IsAny<JwsPayload>()))
